        ...
        <div className="mx-auto py-16 sm:py-24 lg:py-32">
          <div className="text-left">
            ...
            <div className="hidden mt-10 sm:mb-20 sm:flex sm:justify-start">
              <div className="availability relative rounded-full px-3 py-2 text-sm/6 bg-transparent border-1 border-neutral-300">
                <Zap
                  size={16}
            ...
            <div className="flex items-center justify-start gap-x-6">
              ...
              <a
                href="#contact"
                className="font-normal rounded-2xl px-5 py-3.5 text-md border-1 border-neutral-300 transition-colors duration-300 "
              >
                <div className="flex items-center gap-2">
