  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="hero-surface relative overflow-hidden rounded-3xl px-6 pt-64 pb-4 text-center backdrop-blur-sm sm:px-12 sm:pt-64 sm:pb-16 lg:px-16 lg:pt-[240px] lg:pb-4">
          <header className="flex flex-col items-center gap-8">
            ...
            <div className="mt-8 hero-actions flex flex-wrap items-center justify-center gap-3 sm:gap-4">
              <a
                href="#contact"
                className="call-to-action relative z-30 inline-flex items-center gap-2 rounded-2xl border bg-[var(--background)]/90 px-6 py-3 text-base font-medium text-foreground transition-colors duration-300"
              >
